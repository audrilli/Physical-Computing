...
// MQTT client details:
let broker = {
  hostname: 'audrey.cloud.shiftr.io',
  port: 443
 };
...
let topicDiameter = 'value';
let topicSlider = "brightness";
...
function onMessageArrived(message) {
  ...
  else if(receivedMessage.startsWith("value")){
    let diameter1 = split(receivedMessage, ',');
    diameter = diameter1[1];
  }
...
function slideLed() {
  sendMqttMessage(val, topicSlider);
}
